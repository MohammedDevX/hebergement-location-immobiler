  ...
  function updatePriceDisplay() {
    if (startDate && endDate) {
      ...
      document.querySelector(".text-lg.font-bold").innerHTML =
        `${totalPrice} € <span class="text-sm font-normal">pour ${nights} nuits</span>`;
      ...
      if (priceDetails.length >= 3) {
        ...
        priceDetails[2].innerHTML = `<p>Total</p><p>${totalPrice + SERVICE_FEE} €</p>`;
      }
    } else {
      ...
      const priceDetails = document.querySelectorAll(".space-y-2.text-sm .flex");
      if (priceDetails.length >= 3) {
        priceDetails[0].innerHTML = '<p class="underline">285 € x 5 nuits</p><p>1 425 €</p>';
